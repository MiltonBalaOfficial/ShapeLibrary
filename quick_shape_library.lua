-- Register Toolbar actions and initialize UI stuff
      function initUi()
        app.registerUi({["menu"] = "Insert Shapes", ["callback"] = "showMainShapeDialog",  ["toolbarId"] = "shapedialog", ["iconName"] = "shapes_symbolic"})  
        app.registerUi({["menu"] = "Extract_Stroke_Info", ["callback"] = "store_stroke_info_in_file", ["toolbarId"] = "StrInfo", ["iconName"] = "extract-info-symbolic"}) 
